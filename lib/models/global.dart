...
User follower1 = new User(
    'rocky', AssetImage('lib/assets/follower3.jpeg'), [], [], [], [], true);
User follower2 = new User(
    'Reshav', AssetImage('lib/assets/follower2.jpg'), [], [], [], [], false);
User follower3 = new User(
    'Ajay', AssetImage('lib/assets/their_profile.jpeg'), [], [], [], [], true);
User follower4 = new User(
    'Rani', AssetImage('lib/assets/profile3.png'), [], [], [], [], true);
User follower5 = new User(
    'Amit', AssetImage('lib/assets/profile6.jpg'), [], [], [], [], true);
User follower6 = new User(
    'pranav', AssetImage('lib/assets/profile4.png'), [], [], [], [], false);
List<Post> userPosts = [
  new Post(
      new AssetImage('lib/assets/photo_1.jpeg'),
      user,
